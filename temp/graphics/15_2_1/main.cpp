...
try
{
    ...
    Graph_lib::Function s1(one,   r_min,r_max,orig,n_points,x_scale,y_scale);
    ...
    Graph_lib::Text ts(Point(100,y_orig-40),"one");
    Graph_lib::Text ts2(Point(100,y_orig+y_orig/2-20),"x/2");
    Graph_lib::Text ts3(Point(x_orig-100,20),"x*x");
    win0.attach(ts);
    win0.attach(ts2);
    win0.attach(ts3);
    ...
    Graph_lib::Axis x(Graph_lib::Axis::x,Point(20,y_orig), xlength, xlength/x_scale, "one notch == 1");
    Graph_lib::Axis y(Graph_lib::Axis::y,Point(x_orig, ylength+20), ylength, ylength/y_scale, "one notch == 1");
    win0.attach(x);
    win0.attach(y);
